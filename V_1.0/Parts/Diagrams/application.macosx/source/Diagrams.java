...
public class Diagrams extends PApplet {
...
//Conditions.
 //public void Diagram(boolean Diagram) {
   //if (Diagram = true) {
   //  smooth();
    // yTint=yTint-50;
    // yTint=yTint-50;
 ...
 // }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "Diagrams" };
    if (passedArgs != null) {
